...
from .views import HomePage, AboutPage, ContactPage, ProductPage, DellProducts, HPProducts, ProductDetails, AddProducts, Accessories, Softwares
...
urlpatterns = [
	...
	path("softwares/", Softwares.as_view(), name = "softwares"),
